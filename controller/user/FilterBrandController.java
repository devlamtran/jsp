...
@WebServlet("/home/FilterBrandController")
public class FilterBrandController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (session.getAttribute("pageNumberProductBrand") != null) {
			pageNumber = (Integer) session.getAttribute("pageNumberProductBrand");
		}
		...
		allProductRequest.setListProduct(serviceWeb.getProductsByBrand(brand));
