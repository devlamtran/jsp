...
@WebServlet("/home/PagingProductSearchController")
public class PagingProductSearchController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
	    ...
	    if (req.getParameter("pageNumber") != null) {
			...
			session.setAttribute("pageNumberProductSearch", pageNumber);
		}
