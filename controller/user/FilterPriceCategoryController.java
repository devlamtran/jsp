...
@WebServlet("/home/FilterPriceCategoryController")
public class FilterPriceCategoryController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		allProductRequest.setListProduct(serviceWeb.getProductCategoryHasPriceLower(categoryId,price));
...
//	private List<Product> getProductsHasPriceLower(List<Product> productCategoryPaging, BigDecimal price) {
//		List<Product> listproduct = new ArrayList<Product>();
//		for (Product product : productCategoryPaging) {
//			if (product.getPrice().doubleValue()<= price.doubleValue()) {
