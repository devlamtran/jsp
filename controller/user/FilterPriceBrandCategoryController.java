...
@WebServlet("/home/FilterPriceBrandCategoryController")
public class FilterPriceBrandCategoryController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (session.getAttribute("pageNumberPriceBrandCategory") != null) {
			pageNumber = (Integer) session.getAttribute("pageNumberPriceBrandCategory");
		}
		...
		allProductRequest.setListProduct(serviceWeb.getProductCategoryBrandPriceLower(categoryId,price,brand));
