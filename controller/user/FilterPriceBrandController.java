...
@WebServlet("/home/FilterPriceBrandController")
public class FilterPriceBrandController extends HttpServlet {
	...
	protected void doGet(HttpServletRequest req, HttpServletResponse resp) throws ServletException, IOException {
		...
		if (session.getAttribute("pageNumberPriceBrand") != null) {
			pageNumber = (Integer) session.getAttribute("pageNumberPriceBrand");
		}
		...
		allProductRequest.setListProduct(serviceWeb.getProductsBrandPriceLower(price,brand));
